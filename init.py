# AOC Template from [Alexe Simon](https://github.com/AlexeSimon/adventofcode) to automatically grab input from AoC website
# and generate folder structure

# USER SPECIFIC PARAMETERS
base_pos = "./"            # Folders will be created here. If you want to make a parent folder, change this to ex "./adventofcode/"
USER_SESSION_ID = "53616c7465645f5f3886543c65899c7db9d2abf57c2d84fc79572b2f4b6fa6ac7f4194f0d499f06a1f0a54d7f3edb9b031a26acbc83effebf36643399788a827"       # Get your session by inspecting the session cookie content in your web browser while connected to adventofcode and paste it here as plain text in between the ". Leave at is to not download inputs.
...
author = "Mike Ion"               # Name automatically put in the code templates.
